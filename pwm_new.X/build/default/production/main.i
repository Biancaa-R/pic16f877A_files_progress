...
unsigned char pwm20_low;
unsigned char pwm20_high;

unsigned char pwm60_high;
unsigned char pwm60_low;
unsigned char pwm90_high;
unsigned char pwm90_low;
...
void pwm_dutycycle_update(void){
    CCPR1L = pwm20_high;
    CCP1CON = (CCP1CON & 0xCF) | ((pwm20_low ) << 4);
    _delay((unsigned long)((1000)*(6000000/4000.0)));

    CCPR1L = pwm60_high;
    CCP1CON = (CCP1CON & 0xCF) | ((pwm60_low ) << 4);
    _delay((unsigned long)((1000)*(6000000/4000.0)));

    CCPR1L = pwm90_high;
    CCP1CON = (CCP1CON & 0xCF) | ((pwm90_low ) << 4);
    _delay((unsigned long)((1000)*(6000000/4000.0)));
}
